...
@Table(
    ...
    uniqueConstraints =
        @UniqueConstraint(
            name = "training_paths_institution_id_id_unique",
            columnNames = {"institution_id", "training_path_id"}))
@Getter
@NoArgsConstructor
@AllArgsConstructor(access = AccessLevel.PRIVATE)
@Builder(access = AccessLevel.PACKAGE)
public class TrainingPath extends SoftDeletable {

  @Id
  @GeneratedUUIDv7
  @Column(name = "training_path_id")
  private UUID id;
