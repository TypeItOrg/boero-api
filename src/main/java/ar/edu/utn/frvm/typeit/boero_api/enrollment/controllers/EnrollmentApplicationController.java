...
public class EnrollmentApplicationController {
  ...
  @GetMapping(value = "/enrollment-applications", version = Version.V1)
  ...
  @GetMapping(value = "/enrollment-applications/{applicationId}", version = Version.V1)
  @RequiresPermission(PermissionCode.ENROLLMENT_APPLICATION_READ)
  ...
  @PostMapping(value = "/enrollment-applications/{applicationId}/approve", version = Version.V1)
  ...
  @PostMapping(value = "/enrollment-applications/{applicationId}/reject", version = Version.V1)
