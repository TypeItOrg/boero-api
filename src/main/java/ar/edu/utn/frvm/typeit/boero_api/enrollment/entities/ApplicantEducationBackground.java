...
@Entity
@Table(
    name = "applicant_education_backgrounds",
    uniqueConstraints =
        @UniqueConstraint(
            name = "applicant_education_bg_application_unique",
            columnNames = {"enrollment_application_id"}))
@Getter
@NoArgsConstructor
...
public class ApplicantEducationBackground extends SoftDeletable {
  ...
  public void updateSecondarySchool(final String secondarySchool) {
