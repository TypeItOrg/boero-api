...
public class MyEnrollmentApplicationController {
  ...
  private final StartEnrollmentApplicationUseCase startEnrollmentApplicationUseCase;
  private final UpdateEnrollmentDraftUseCase updateEnrollmentDraftUseCase;
  private final SubmitEnrollmentApplicationUseCase submitEnrollmentApplicationUseCase;
  ...
  public EnrollmentApplicationResponse start(
    ...
    return startEnrollmentApplicationUseCase.execute(
  ...
  public EnrollmentApplicationResponse updateDraft(
      ...
      final Authentication authentication) {
    return updateEnrollmentDraftUseCase.execute(
        institutionId, currentPersonId(authentication), applicationId, request);
  }
  ...
  public EnrollmentApplicationResponse submit(
      ...
      @PathVariable final UUID applicationId,
      final Authentication authentication) {
    return submitEnrollmentApplicationUseCase.execute(
        institutionId, currentPersonId(authentication), applicationId);
  }
